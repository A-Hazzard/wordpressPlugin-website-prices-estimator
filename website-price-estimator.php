...
if (!class_exists('WebsitePriceEstimator')) {
  ...
  class WebsitePriceEstimator
  {
      ...
      <div class="step step-1 h-[35rem]">
        <div class="text-lg mt-3 px-4 flex flex-col gap-2">
          ...
          <input
            ...
            placeholder="1"
            min="1"
            class="pages-input w-2/3 rounded-md px-2 py-1 border focus:border-blueTheme"
            inputmode="numeric"
            pattern="[0-9]*"
          />
      ...
      <div class="px-4 pb-4 mt-3 lex-col gap-2 step step-3 absolute hidden">
        ...
        <div class="plans text-[0.9rem] mt-2 flex flex-col">
          ...
          <div class="plan-item flex items-center">
            ...
            />
            <label class="ml-2 mt-3"
              >Website Maintenance Package: <br />3 Hour SLA - $130/month</label
            >
          </div>
          <div class="plan-item flex items-center">
            <input
            ...
            />
            <label class="ml-2 mt-3"
              >Website Maintenance Package: <br />5 Hour SLA - $220/month</label
            >
          </div>
          <div class="plan-item flex items-center">
            <input
            ...
            />
            <label class="ml-2 mt-3"
              >Website Maintenance Package: <br />8 Hour SLA - $315/month</label
            >
          </div>
        </div>
    ...
    >
      ...
      <div class="step step-1 transition-height duration-300 ease-in-out">
        <div class="text-lg mt-3 px-4 flex flex-col gap-2">
          ...
          <button
            class="first-next-step w-1/2 mt-3 p-1 text-white bg-yellowTheme rounded-md"
          >
            Next <i class="fa-solid fa-arrow-right"></i>
          </button>
        </div>
    ...
    <!-- SUMMARY MODAL -->
    <div
      class="modal fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 flex items-center justify-center"
    >
        ...
        <div class="px-6 pb-6 flex flex-col items-center">
          ...
          <div class="lg:w-3/4">
            <div class="currency-input-container w-2/4 max-w-md mb-4">
              <select class="currency-select w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellowTheme focus:border-transparent">
